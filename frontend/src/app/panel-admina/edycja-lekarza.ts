...
@Component({
  selector: 'app-edycja-lekarza-dialog',
  standalone: true,
  imports: [CommonModule, FormsModule, MaterialModule, MatDialogModule, TranslateModule],
  template: `
    <h2 mat-dialog-title style="color: #2e8eff;">{{ 'ADMIN_PANEL.EDIT_DOCTOR_TITLE' | translate }}</h2>
    <mat-dialog-content>
      <div class="edit-dialog-form">
        ...
        <mat-form-field appearance="outline">
          <mat-label>{{ 'ADMIN_PANEL.LBL_SPECIALTY' | translate }}</mat-label>
          <input matInput [(ngModel)]="dane.specjalizacja">
        </mat-form-field>
        <mat-form-field appearance="outline">
...
export class EdycjaLekarzaDialog {
  dane: any;
  constructor(
    public dialogRef: MatDialogRef<EdycjaLekarzaDialog>,
